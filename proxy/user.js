...
exports.addNewUser = function(userdata, callback) {
    var newUser = new User({
        ...
        headimgurl: userdata.wishwallheadimgurl,
        wechatheadimgurl: userdata.headimgurl
    });
...
exports.loverSet = function(uid, myname, hisname, hisid, callback) {
    User.update({
        _id: uid
    }, {
        $set: {
            ...
            mystery_lover_id: hisid
        }
    }, callback);
};

exports.setMatchState = function(uid, state, callback) {
    User.update({
        _id: {
            "$in": uid
        }
...
exports.loverMatch = function(macth_data, callback) {
    User.findOne({
        ...
        mystery_lover: macth_data.myname
    }, callback);
};